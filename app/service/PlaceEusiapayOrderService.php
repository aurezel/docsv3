...
class PlaceEusiapayOrderService extends BaseService
{
    public function placeOrder(array $params = [])
    {
        ...
        try{
            ...
            $returnUrl = $baseUrl . '/' . basename(app()->getRootPath()) . (empty($sPath) ? '/pay/eusReturn' : $sPath). '?cid='.$cid;
            $notifyUrl = $baseUrl . '/' . basename(app()->getRootPath()) . (empty($nPath) ? '/pay/eusNotify' : $nPath) . '?cid='.$cid;
